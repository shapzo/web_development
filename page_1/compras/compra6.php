...
<html lang="es">
  ...
  <center><img src="../img/img_scar1.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >El Lamborghini Huracán EVO es un superdeportivo de motor central que se posiciona 
        en la gama de Lamborghini por debajo del Lamborghini Aventador. El Lamborghini Huracán fue
         presentado en 2014 como sustituto del Lamborghini Gallardo y posteriormente actualizado 
         como "Huracán EVO" en enero de 2019.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 6";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo6.php" method="post">
