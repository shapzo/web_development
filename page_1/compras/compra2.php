...
<html lang="es">
  ...
  <center><img src="../img/img_cam2.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >Cybertruck está fabricado con un revestimiento exterior hecho para máxima durabilidad y protección
         de los pasajeros. Comenzando con un exoesqueleto casi impenetrable, todos los componentes están diseñados para
          proporcionar resistencia y firmeza superiores, desde la capa estructural de acero inoxidable laminado en frío
           ultraduro de 30X hasta el cristal blindado Tesla.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 2";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo2.php" method="post">
