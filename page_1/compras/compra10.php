...
<html lang="es">
  ...
  <center><img src="../img/img_scar5.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >El McLaren Senna es el coche más radical jamás construido por McLaren, 
        se trata del sucesor del McLaren P1 y de sus versiones P1 GTR y P1 LM. McLaren ha concebido 
        el Senna como un coche de uso exclusivo para circuitos, aún así ha implementado las mínimas
         exigencias para contar con homologación para su uso en carretera.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 10";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo10.php" method="post">
