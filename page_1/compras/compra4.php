...
<html lang="es">
  ...
  <center><img src="../img/img_cam4.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >La icónica Chevrolet Suburban lleva más de 85 años de recorrer un camino lleno de determinación y éxito.
         Esta nueva generación ofrece mayor espacio para los pasajeros, un motor más potente y lo último en tecnología.
         Nuestra icónica Chevrolet Suburban fue rediseñada para mejorar su espacio interior, confort, conectividad y
        desempeño con lo último en tecnología que la ha hecho destacar en su categoría. Conoce esto y más a detalle en nuestro review.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 4";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo4.php" method="post">
