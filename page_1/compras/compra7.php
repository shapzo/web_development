...
<html lang="es">
  ...
  <center><img src="../img/img_scar2.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >El Ferrari F8 Tributo es la nueva berlinetta biplaza con motor central-trasero, 
        máximo exponente de este tipo de vehículo de la casa del Cavallino Rampante. Se trata de un coche con características
         únicas y, como su nombre indica, que homenajea al motor V8 Ferrari más potente de la historia.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 7";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo7.php" method="post">
