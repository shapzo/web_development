...
<html lang="es">
  ...
  <center><img src="../img/img_tcar5.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >Su Completo Equipamiento, Seguridad, Espacio y Confort lo Convierten en la Mejor Opción. Elige y
         Cotiza Aquí tu Versión Preferida: Trendline, Comfortline, R-Line y Highline. Estrénalo con Promociones.
          Faros y Calaveras LED</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 12";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo12.php" method="post">
