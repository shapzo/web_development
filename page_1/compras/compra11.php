...
<html lang="es">
  ...
  <center><img src="../img/img_tcar1.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >El Tsuru es un automóvil muy consolidado en México, ya que cuenta con una larga trayectoria desde 1982 
        y tres generaciones de este modelo. ​ Es un modelo favorito para quienes buscan un buen espacio interior y robustez
         a un precio accesible, como es el caso de los taxistas y flotilleros.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 11";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo11.php" method="post">
