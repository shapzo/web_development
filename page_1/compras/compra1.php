...
<html lang="es">
  ...
  <center><img src="../img/img_cam1.png" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >Conoce la espectacular Camioneta Todoterreno Ford Ranger Raptor, 
      la nueva integrante de la familia Ford Raptor, equipada con tecnología 
      desarrollada por Ford Performance y un potente motor Diésel PANTHER 
      de 210 Caballos de Fuerza y 369 lb-pie de torque para entregar un 
      desempeño Off-Road excepcional.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 1";
