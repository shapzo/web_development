...
<html lang="es">
  ...
  <center><img src="../img/img_scar4.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >El 911 GT3 RS es el modelo más radicalmente deportivo y puro de la gama de la firma alemana,
         con una aerodinámica y chasis pensados para su utilización en circuito, pero homologado para su uso legal
          en carretera. Su excelente tiempo de 7:42 en el antiguo circuito de Nürburgring, demuestran cuál es su auténtico hábitat.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 9";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo9.php" method="post">
