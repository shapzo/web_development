...
<html lang="es">
  ...
  <center><img src="../img/img_cam3.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
      <p id="one" >Su amplio espacio interior da una increíble sensación de libertad a todos los pasajeros. 
        Transmisión automática de 10 velocidades y control de cambios. Hotspot Wi-Fi®. Stabilitrak®. 10 Velocidades. 
        Sistema de audio BOSE®. Magnetic Ride Control™.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 3";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo3.php" method="post">
