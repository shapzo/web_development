...
<html lang="es">
  ...
  <center><img src="../img/img_tcar4.jpg" alt=""></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <center><div class="col-sm-8" id="hablas">
  <p id="one" >El Subaru Impreza es un automóvil de turismo del segmento C producido por el
         fabricante japonés Subaru desde el año 1992. La segunda generación del Impreza fue lanzada en 2002 ,
          y la tercera fue presentada al público en 2007. Su principal rival fue el Mitsubishi Lancer.</p>
  </div></center>
    ...
    $laVehiculos = array();
    $sqlVehiculos = "SELECT * FROM Vehiculos WHERE Id = 14";
   ...
   <div class="divs">
       ...
       <div align="right"><img class="img-fluid rounded girls" loading="lazy" src="../img/img_woman3.jpg" width="60%"></div>
                 ...
                 <center> <div class="col-sm-8" id="hablas">
                  ...
                  <center>
                  <div>
                  <form class="form-horizontal" action="../Recibos/recibo14.php" method="post">
